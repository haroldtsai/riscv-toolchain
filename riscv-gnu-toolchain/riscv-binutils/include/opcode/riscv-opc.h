...
/* Bitmanip instructions opcode macros.  */
...
/* K-ext instructions opcode macros.  */
#define MATCH_POLLENTROPY 0xdbf02073
...
DECLARE_CSR(mnoise, CSR_MNOISE, CSR_CLASS_DEBUG, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
